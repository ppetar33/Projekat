...
public class ProzorZaDodeljivanjeVoznjiAplikacijaAukcijom extends JFrame {
    ...
    public ProzorZaDodeljivanjeVoznjiAplikacijaAukcijom(Liste ucitavanje, NarucivanjeVoznjePrekoAplikacije voznja, DoublyLinkedList<String> vozaci) {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(dodeljeniVozac.getStatusVozaca().equals(StatusVozacaIautomobila.ZAUZET)){
                    ...
                    if (statusVoznje != StatusVoznje.DODELJENA) {
                        ...
                        if (voznja == null) {
                            voznja = new NarucivanjeVoznjePrekoAplikacije(id, dateTime, adresaPolaska, adresaDolaska, musterija1, dodeljeniVozac, brojKmPredjenih, trajanjeVoznje, statusVoznje1, obrisan, statusNaruceneVoznje, 0,ocenjenVozac,izborMusterijePriNarucivanju,napomena);
                        } else {
                            voznja.setId(id);
                        ...
                        ProzorZaDodeljivanjeVoznjiAplikacijaAukcijom.this.setVisible(false);
                        ProzorZaDodeljivanjeVoznjiAplikacijaAukcijom.this.dispose();
                        ...
                        for(Aukcija aukcija : aukcijaDoublyLinkedList){
                            if(aukcija.getIDvoznje() == voznja.getId() && aukcija.getVozacKojiUcestvujeUaukciji().equals(vozacKojiJeDobioVoznju) && aukcija.getStatusNaruceneVoznje().equals(StatusNaruceneVoznje.APLIKACIJA)){
