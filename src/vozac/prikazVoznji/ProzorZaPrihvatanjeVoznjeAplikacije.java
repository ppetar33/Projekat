...
public class ProzorZaPrihvatanjeVoznjeAplikacije extends JFrame {
    ...
    public ProzorZaPrihvatanjeVoznjeAplikacije(Liste ucitavanje, NarucivanjeVoznjePrekoAplikacije voznja) {
        ...
        potvrdi.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (statusVoznje != StatusVoznje.PRIHVACENA) {
                    ...
                    if (voznja == null) {
                        voznja = new NarucivanjeVoznjePrekoAplikacije(id, dateTime, adresaPolaska, adresaDolaska, musterija1, vozac1, brojKmPredjenih, trajanjeVoznje, statusVoznje1, obrisan, statusNaruceneVoznje,0,ocenjenVozac,izborMusterije,napomena);
                    } else {
                        voznja.setId(id);
                    ...
                    ProzorZaPrihvatanjeVoznjeAplikacije.this.setVisible(false);
                    ProzorZaPrihvatanjeVoznjeAplikacije.this.dispose();
                }
            }
        });
